...
from beebi.analysis.feed.sub_agents.feed_consistency_agent.agent import analyze_feed_consistency
from beebi.analysis.feed.sub_agents.feed_interval_agent.agent import analyze_feed_intervals
from beebi.analysis.feed.sub_agents.feed_time_of_day_agent.agent import analyze_feed_time_of_day
from beebi.analysis.feed.sub_agents.feed_type_agent.agent import analyze_feed_type_ratio
from beebi.analysis.feed.sub_agents.feed_volume_agent.agent import analyze_feed_volume
...
def format_feed_report(
    ...
    """
    Generate a structured English feeding report.
    """
...
# Define sub-agent
comprehensive_feed_report_agent = Agent(
    name="comprehensive_feed_report_agent",
    ...
    output_key="comprehensive_feed_report"
)