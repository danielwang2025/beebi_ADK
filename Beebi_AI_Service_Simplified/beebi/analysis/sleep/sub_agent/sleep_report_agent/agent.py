...
def format_sleep_report(
    ...
    """
    Generate a structured English sleep report based on the results of three analysis functions.
    Parameters:
    - days: Number of days analyzed
    - sessions_data: Result from analyze_sleep_sessions
    - anomalies_data: Result from detect_sleep_anomalies
    - patterns_data: Result from analyze_sleep_patterns

    Returns:
    - A formatted English report text
    """
...
from ..sleep_analysis_agent.agent import analyze_sleep_sessions
from ..sleep_anomaly_agent.agent import detect_sleep_anomalies
from ..sleep_pattern_agent.agent import analyze_sleep_patterns
