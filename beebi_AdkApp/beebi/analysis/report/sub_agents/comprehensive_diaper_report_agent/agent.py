...
from beebi.analysis.diaper.sub_agents.diaper_frequency_agent.agent import analyze_diaper_frequency
from beebi.analysis.diaper.sub_agents.diaper_type_analysis_agent.agent import analyze_diaper_type
from beebi.analysis.diaper.sub_agents.diaper_timing_agent.agent import analyze_diaper_timing
from beebi.analysis.diaper.sub_agents.diaper_duration_agent.agent import analyze_diaper_duration
from beebi.analysis.diaper.sub_agents.diaper_alert_agent.agent import analyze_diaper_alert

# Structured report function
def format_diaper_report(
    ...
    """
    Generate a structured diaper analysis report.
    """
...
# Define sub-agent
comprehensive_diaper_report_agent = Agent(
    name="comprehensive_diaper_report_agent",
    ...
    output_key="comprehensive_diaper_report"
)