...
def format_sleep_report(
    ...
    """
    Generate a structured English sleep report based on three analysis functions.
    Args:
    - days: Number of days analyzed
    - sessions_data: Output from analyze_sleep_sessions
    - anomalies_data: Output from detect_sleep_anomalies
    - patterns_data: Output from analyze_sleep_patterns
...
from beebi.analysis.sleep.sub_agent.sleep_analysis_agent.agent import analyze_sleep_sessions
from beebi.analysis.sleep.sub_agent.sleep_anomaly_agent.agent import detect_sleep_anomalies
from beebi.analysis.sleep.sub_agent.sleep_pattern_agent.agent import analyze_sleep_patterns
...
# Define sub-agent
comprehensive_sleep_report_agent = Agent(
    name="comprehensive_sleep_report_agent",
    ...
    output_key="comprehensive_sleep_report"
)