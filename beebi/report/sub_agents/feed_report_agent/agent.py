...
# 导入各分析子模块
from beebi.feed.sub_agents.feedconsistencyagent.agent import analyze_feed_consistency
from beebi.feed.sub_agents.feedintervalagent.agent import analyze_feed_intervals
from beebi.feed.sub_agents.feedtimeofdayagent.agent import analyze_feed_time_of_day
from beebi.feed.sub_agents.feedtypeagent.agent import analyze_feed_type_ratio
from beebi.feed.sub_agents.feedvolumeagent.agent import analyze_feed_volume
